...
export default function User() {
    ...
    return (
        <section className="flex gap-4 flex-col lg:flex-row justify-around bg-gradient-to-r from-indigo-600 via-gray-50 to-gray-50 items-center p-6 lg:p-10 min-h-screen">
